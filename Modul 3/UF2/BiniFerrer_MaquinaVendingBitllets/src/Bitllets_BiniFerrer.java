...
public class Bitllets_BiniFerrer {
    ...
    private static double SeguirComprant (Scanner sc){ // Mètode per seguir comprant bitllets
        ...
        total = preu * comptador; //Calcula el preu de diversos bitllets del mateix tipus
        numeroBitllets = numeroBitllets + comptador; //Compta el nombre de bitllets en total
